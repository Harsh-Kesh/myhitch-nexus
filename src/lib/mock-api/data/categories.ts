...
const rawCategories: Category[] = [
  ...
  {
    id: "cat_music_singles",
    slug: "singles-and-eps",
    name: "Singles & EPs",
    description: "New tracks and short releases from independent and signed artists.",
    contentType: "music",
    featured: true,
    videoCount: 0,
    accentToken: 6,
    imageUrl: "/images/categories/cat_music_singles.svg",
  },
  {
    id: "cat_music_albums",
    slug: "albums",
    name: "Albums",
    description: "Full-length releases, grouped as playlists by the uploading artist.",
    contentType: "music",
    featured: false,
    videoCount: 0,
    accentToken: 2,
    imageUrl: "/images/categories/cat_music_albums.svg",
  },
  {
    id: "cat_podcast_interviews",
    slug: "interviews-and-conversations",
    name: "Interviews & conversations",
    description: "Long-form conversation and interview shows.",
    contentType: "podcast",
    featured: true,
    videoCount: 0,
    accentToken: 3,
    imageUrl: "/images/categories/cat_podcast_interviews.svg",
  },
  {
    id: "cat_podcast_true_crime",
    slug: "true-crime",
    name: "True crime",
    description: "Investigative and true-crime audio series.",
    contentType: "podcast",
    featured: false,
    videoCount: 0,
    accentToken: 5,
    imageUrl: "/images/categories/cat_podcast_true_crime.svg",
  },
];
