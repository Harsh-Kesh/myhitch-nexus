// GET /api/campaigns/[id] — a single campaign, for the advertiser's own detail page or
// the admin approval queue's detail view. Same ownership-or-admin-tier gate as the list route.
import { NextResponse, type NextRequest } from "next/server";
import { getCampaignById } from "@/lib/server/campaigns";
